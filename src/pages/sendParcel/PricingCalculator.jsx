      ...
      <form onSubmit={handleSubmit(handleCalculate)}>
        <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg max-h-[90vh] flex flex-col overflow-hidden">
          ...
          <div className="p-8 pb-6 border-b border-gray-100 flex-shrink-0">
            <div className="flex justify-between items-start">
              ...
              <button
                ...
                className="text-gray-400 hover:text-gray-600 text-3xl leading-none mt-1 mr-2"
              >
          ...
          <div className="flex-1 overflow-y-auto p-8">
            {showDetails ? (
              // ✅ DETAILS VIEW
             <CalculateInfo setShowDetails={setShowDetails}/>
            ) : (
          ...
          {/* Result */}
          {!showDetails && calculateCost !== null && (
            <div className="mt-6 w-full max-w-md mx-auto p-6 bg-emerald-50 border border-emerald-200 rounded-2xl shadow-lg flex flex-col items-center text-center">
